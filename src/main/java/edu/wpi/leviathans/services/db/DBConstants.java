...
public class DBConstants {
	...
	public static final String addMuseum =
			"INSERT INTO Museums(name, location, phone_number, date_established)"
					+ "VALUES(?, ?, ?, ?)";

	// Add new painting to test database
	public static final String addPainting =
			"INSERT INTO Paintings(name, museum_id, artist, date_painted)"
					+ "VALUES(?, ?, ?, ?)";
	...
	public static final String updateMuseumPhone =
			"INSERT INTO Museums(phone_number)" + "VALUES(?)"
					+ "WHERE name = ?";
}
